...
Usage:
  npm run issues -- <command> [options]
...
Examples:
  npm run issues -- create -t "Broken link" -b "Details..."
  npm run issues -- read -s open -l 10
  npm run issues -- read -n 123 --comments
  npm run issues -- comment -n 123 -b "I can reproduce this."
  npm run issues -- close -n 123 -b "Fixed in #456."
  npm run issues -- worklist
